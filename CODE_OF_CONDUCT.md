...
> The presenters is responsible for enforcing the Code of Conduct. Some of that responsibility is delegated to platform moderators to ensure quick and tailored response.

The Code of Conduct defines our standards of behavior, but it should not be used as a rulebook to resolve every disagreement. **We value a collaborative environment where everyone works to resolve conflict constructively.** This page describes the process to follow when individual attempts to resolve conflict have failed, or are infeasible.
